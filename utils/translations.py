...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    'en': {
        ...
        'classes': 'Classes',
        'class_kg': 'KG Class',
        'class_1_2': '1st & 2nd Primary',
        'class_3_4': '3rd & 4th Primary',
        'class_5_6': '5th & 6th Primary',
        'class_middle': 'Middle School',
        'class_secondary': 'High School',
        'class_moms': 'Moms Class',
    ...
    'ar': {
        ...
        'classes': 'الفصول',
        'class_kg': 'فصل كي جي',
        'class_1_2': 'أولى وثانية ابتدائي',
        'class_3_4': 'ثالثة ورابعة ابتدائي',
        'class_5_6': 'خامسة وسادسة ابتدائي',
        'class_middle': 'إعدادي',
        'class_secondary': 'ثانوي',
        'class_moms': 'فصل الأمهات',
